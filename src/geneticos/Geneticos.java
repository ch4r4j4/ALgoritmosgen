...
public class Geneticos {
     ...
     */
    static int filas=6; //6 comidas al dia
    static int columnas=5;//alimentos que se debe incluir
    static int Nganadores=3;//ganadores
    ...
    //Calculo del valor porcentual de la comidad del individuo de acuerdo a sus genes 0 y 1*/
